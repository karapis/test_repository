...
public class HelloServiceLocator extends org.apache.axis.client.Service implements tests.webservice.HelloService {
    ...
    public tests.webservice.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tests.webservice.HelloSoapBindingStub _stub = new tests.webservice.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tests.webservice.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                tests.webservice.HelloSoapBindingStub _stub = new tests.webservice.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.tests", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.tests", "Hello"));
        }
